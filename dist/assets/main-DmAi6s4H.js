...
Are you sure?`)){if(!confirm('Final confirmation: Type "RESET" to confirm')&&prompt('Type "RESET" to confirm complete data reset:')!=="RESET"){alert("Reset cancelled");return}o.reset(),alert("All data has been reset"),window.navigate("/setup")}};const g={"/":{render:$,requiresAuth:!0,blockedBy:["NODE_REQUIRED"]},"/login":{render:M,requiresAuth:!1,redirectIfAuthed:"/dashboard"},"/setup":{render:q,requiresAuth:!0},"/dashboard":{render:$,requiresAuth:!0,blockedBy:["NODE_REQUIRED"]},"/nodes":{render:W,requiresAuth:!0},"/providers":{render:z,requiresAuth:!0,blockedBy:["NODE_REQUIRED"]},"/tasks":{render:ee,requiresAuth:!0,blockedBy:["NODE_REQUIRED"]},"/tasks/new":{render:ae,requiresAuth:!0,blockedBy:["NODE_REQUIRED","PROVIDER_REQUIRED"]},"/tasks/:id":{render:t=>ie(t),requiresAuth:!0,blockedBy:["NODE_REQUIRED"],dynamic:!0},"/routing":{render:me,requiresAuth:!0,blockedBy:["NODE_REQUIRED"]},"/settings":{render:we,requiresAuth:!0},"/billing":{render:()=>"<h1>Billing</h1><p>Coming soon.</p>",requiresAuth:!0},"/locked":{render:Ee,requiresAuth:!0}};function Ce(t){const e=g[t]||g["/dashboard"],s=o.get("auth"),n=o.getBlocks();if(e.requiresAuth&&!s.isAuthenticated)return{allowed:!1,redirect:"/login"};if(!e.requiresAuth&&s.isAuthenticated&&e.redirectIfAuthed)return{allowed:!1,redirect:e.redirectIfAuthed};if(e.blockedBy)for(const a of e.blockedBy){const i=n.find(r=>r.id===a);if(i)return{allowed:!1,blockedBy:i}}return{allowed:!0}}function Ee(){const e=o.getBlocks()[0]||{message:"Setup required",cta:{text:"Go to Setup",href:"#/setup"}};return`
  ...
  `}async function p(t,e=!1){e||window.history.pushState({},"",t);const s=Ce(t);if(!s.allowed){if(s.redirect){p(s.redirect,!0);return}if(s.blockedBy){window.__currentBlock=s.blockedBy,C("/locked");return}}await C(t)}async function C(t){const e=document.getElementById("app"),s=g[t]||g["/dashboard"];e.innerHTML='<div class="loading-screen"><div class="spinner"></div><p>Loading...</p></div>';try{if(o.get("auth").isAuthenticated&&!o.isSetupComplete()&&t!=="/setup"&&t!=="/login"){const a=await s.render();e.innerHTML=Ie()+a}else{const a=await s.render();e.innerHTML=a}Ne()}catch(n){console.error("Render error:",n),e.innerHTML=`
